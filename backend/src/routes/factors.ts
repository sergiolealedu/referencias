    ...
    try {
      ...
      res.json({
        prompt: [
          ...
          '   sem login, mas EXPIRA (veja "pdfExpiraEm"). O abstract sozinho raramente',
          '   basta: os fatores costumam aparecer nos resultados e na discussão. Se não',
          '   conseguir abrir o PDF, DIGA ISSO explicitamente em vez de analisar só pelo',
          '   abstract — um delta feito às cegas parece bom e está errado.',
          ...
          '  enviado de volta ao sistema no botão "Aplicar delta em artigos".',
