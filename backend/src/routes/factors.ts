    ...
    try {
      ...
      res.json({
        prompt: [
          ...
          '',
          'TRIAGEM — antes de extrair fatores, responda quatro perguntas sobre o artigo:',
          '(1) é da área de engenharia de software? (2) fala de desenvolvimento de',
          'software? (3) os sujeitos estudados são desenvolvedores? (4) o bem-estar',
          'deles — ou algo que o afete — é objeto de análise do artigo (desfecho',
          'medido, tema das entrevistas, alvo das conclusões)?',
          ...
          'reprovam na pergunta 4 — sem efeito sobre bem-estar não há polaridade.',
          '',
